...
Public Class FrmKhachHang
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        txtNgaySinh.Text = DataGridView1.Item(2, index).Value
    ...
    Private Sub Them_Click(sender As Object, e As EventArgs) Handles Them.Click
        ...
        Dim Query2 As String = "insert into KhachHang values (@MaKhachHang,@TenKhachHang,@NgaySinh,@DiaChi,@SoDienThoai)"
        ...
        Try
            ...
            ExecuteQuery1.Parameters.AddWithValue("@NgaySinh", txtNgaySinh.Text)
            ExecuteQuery1.Parameters.AddWithValue("@DiaChi", txtDiaChi.Text)
            ExecuteQuery1.Parameters.AddWithValue("@SoDienThoai", txtSDT.Text)
    ...
    Private Sub BtnSua_Click(sender As Object, e As EventArgs) Handles BtnSua.Click
        ...
        ketnoi.Open()
        Dim Stradd As String = "Update KhachHang set TenKhachHang = @TenKhachHang, MaKhachHang = @MaKhachHang, NgaySinh = @NgaySinh, DiaChi = @DiaChi, SoDienThoai = @SoDienThoai  where MaKhachHang = @MaKhachHang"
    ...
    Private Sub Loaddata()
        ...
        Dim Query1 As SqlDataAdapter = New SqlDataAdapter("select * from KhachHang", ketnoi1)
