...
Public Class FrmLoaiSach
    ...
    Private Sub FrmLoaiSach_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim Query1 As SqlDataAdapter = New SqlDataAdapter("select * from LoaiSach", connect)
        'Kết nối mở ra
        connect.Open()
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        txtMaLS.Text = DataGridView1.Item(0, index).Value
        txtTenLS.Text = DataGridView1.Item(1, index).Value
    End Sub
    ...
    Private Sub Them_Click(sender As Object, e As EventArgs) Handles Them.Click
        ...
        Dim Query2 As String = "insert into LoaiSach values (@MaLoaiSach,@TenLoaiSach)"
        ...
        Try
            ...
            ExecuteQuery1.Parameters.AddWithValue("@TenLoaiSach", txtTenLS.Text)
        ...
        End Try
        'Refresh bang
        Dim Query3 As SqlDataAdapter = New SqlDataAdapter("select * from LoaiSach", connect)
        database.Clear()
    ...
    Private Sub BtnSua_Click(sender As Object, e As EventArgs) Handles BtnSua.Click
        ...
        ketnoi.Open()
        Dim Stradd As String = "Update LoaiSach set TenLoaiSach = @TenLoaiSach, MaLoaiSach = @MaLoaiSach where MaLoaiSach = @MaLoaiSach"
        Dim com As New SqlCommand(Stradd, ketnoi)
        Try
            com.Parameters.AddWithValue("@MaLoaiSach", txtMaLS.Text)
            com.Parameters.AddWithValue("@TenLoaiSach", txtTenLS.Text)
            com.ExecuteNonQuery()
            ketnoi.Close()
    ...
    Private Sub Loaddata()
        ...
        Dim Query1 As SqlDataAdapter = New SqlDataAdapter("select * from LoaiSach", ketnoi1)
    ...
    Private Sub BtnXoa_Click(sender As Object, e As EventArgs) Handles BtnXoa.Click
        Dim ketnoi As New SqlConnection(chuoiketnoi)
        ketnoi.Open()
        Dim xoadl As String = "Delete from LoaiSach Where MaLoaiSach = @MaLoaiSach"
        Dim lenh As New SqlCommand(xoadl, ketnoi)
        Try
            lenh.Parameters.AddWithValue("@MaLoaiSach", txtMaLS.Text)
